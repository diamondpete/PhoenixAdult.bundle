...
searchSites = {
    ...
    313: ('Teen BFF', 'https://www.pornpros.com', '/video/'),
    ...
    686: ('Perv Mom', 'https://www.pervmom.com', '/movies'),
    ...
    848: ('Shoplyfter Mylf', 'https://www.shoplyftermylf.com', '/movies'),
...
def getProviderFromSiteNum(siteNum):
    ...
    if siteNum is not None:
        ...
        # Nubiles
        elif (525 <= siteNum <= 545) or (755 <= siteNum <= 756) or siteNum == 766 or (995 <= siteNum <= 996) or siteNum == 1256 or siteNum == 1360 or (1396 <= siteNum <= 1397) or siteNum == 1551 or (1574 <= siteNum <= 1582):
