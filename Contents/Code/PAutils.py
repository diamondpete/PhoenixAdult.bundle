...
def studio(name, siteNum):
    studios = (
        'Mile High Media', 'Evil Angel', 'Blacked RAW', 'Tushy RAW', 'Reality Kings', '40 Inch Plus', 'HD Love',
        ...
        'Black Meat White Feet', 'Lets Doe It', 'BangBros 18'
    )
...
def manualWordFix(word):
    exceptions = (
        ...
        'ohmy', 'wont', 'whos', 'shouldnt', 'lasirena', 'espanol', 'jmac'
    )
    corrections = (
        ...
        'OhMy', 'Won\'t', 'Who\'s', 'Shouldn\'t', 'LaSirena', 'español', 'J-Mac'
    )
